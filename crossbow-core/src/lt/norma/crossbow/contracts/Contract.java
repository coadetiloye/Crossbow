...
/**
 * Base class for all contracts. Extend this class to create custom contract
 * types.
 * 
...
public abstract class Contract implements Comparable<Contract> {
	...
	/**
	 * Type of this contract. Used only to provide human readable type of the
	 * contract. Internally contract types are identified by class.
	 */
	 ...
	 *            contract symbol
	 * @param type
	 *            type of the contract. Used only to provide human readable type
	 *            of the contract. Internally contract types are identified by
	 *            class.
	 * @param exchange
	 ...
	 */
	public Contract(String symbol, String type, Exchange exchange,
		...
		if (type == null || type.isEmpty()) {
			throw new ContractException("Type of the contract " + symbol
					+ " is not set.");
		}
		if (exchange == null) {
			throw new ContractException("Exchange of the contract " + symbol
					+ " is null.");
		}
		if (currency == null) {
			throw new ContractException("Currency of the contract " + symbol
					+ " is null.");
		}
	 ...
	 * <p>
	 * <code>equals</code> method is final and cannot be overriden, however it
	 * uses <code>compareTo</code> to check if two contracts are equal (when
	 * types of both contracts match and this contract is not compared to
	 * <code>null</code> or itself). Override <code>compareTo</code> method to
	 * create custom comparison of contracts.
	 * 
	 * @param object
	 *            contract
	 * @return true if the specified contract is equal to this contract, false
	 *         otherwise
	 */
	@Override
	 ...
	 *         a negative integer if this contract is "less" than the other
	 *         contract;<br>
