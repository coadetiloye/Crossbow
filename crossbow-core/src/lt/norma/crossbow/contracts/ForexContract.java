...
public class ForexContract extends Contract {
	 ...
	 */
	public ForexContract(Currency currency1, Currency currency2,
			Exchange exchange) throws ContractException {
		super(getCurrencyCode(currency1,
				"The first currency of a forex contract is not set."), "FOREX",
				exchange, currency2);
