...
public class Properties {
	...
	public void add(Property property) throws CrossbowException {
		if (propertyExists(property.getName())) {
			throw new CrossbowException("Unable to add property \""
					+ property.toString()
	...
	/**
	 * Sets existing property or adds a new one. If property with the same name
	 * and type already exists, it will be overriden by a new property. Use
	 * <code>add</code> to safely add a new property or
	 * <code>propertyExists</code> to check for existing properties.
	 * 
	 * @param property
	...
	public void set(Property property) throws CrossbowException {
		...
		if (existingProperty.getType().equals(property.getType())) {
			...
			throw new CrossbowException("Unable to set property \""
					+ property.toString() + "\". Existing property \""
	...
	public Property getByName(String propertyName) throws CrossbowException {
		...
		if (result == null) {
			throw new CrossbowException("Property with name \"" + propertyName
					+ "\" not found.");
		}
		return result;
	}
