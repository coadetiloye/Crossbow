...
/**
 * Generic property. Contains property value, name by wich the property is
 * referred and a short description.
 * 
 * @param <Type>
...
public class Property<Type> implements Comparable<Property> {
	 ...
	 * Constructor.
	 * <p>
	 * Throws <code>InvalidArgumentRuntimeException</code> if property name is
	 * null or empty.
	 * 
	 * @param name
	 *            name by wich the property is referred, cannot be null or
	 *            empty.
	 * @param value
	...
	/**
	 * Alphabetically compares name of the specified property to name of this
	 * property.
	 * 
	 * @param property
	 *            a property to be compared to this property
	 * @return 0 if both properties are have the same name;<br>
	 *         a negative integer if this property is "less" than the specified
	 *         property;<br>
