...
/**
 * An argument passed to a method or constructor is invalid. Throw this runtime exception if the
 * value passed to a method or constructor is invalid and the program is not expected to handle the
 * exception properly.
 * 
...
public class InvalidArgumentRuntimeException extends CrossbowRuntimeException
{
    ...
    * <p>
    * Use this constructor when no causing exception exists and no message is needed to explain the
