...
public class OptionContractTest {
	...
	public void testCreation() throws ContractException {
		...
		OptionContract c = new OptionContract("S", OptionType.CALL,
				new BigDecimal("8.05"), maturityDate, exchange, currency,
				new BigDecimal("100"));
	...
	public void testCompareTo() throws ContractException {
		...
		OptionContract c1 = new OptionContract("S", OptionType.CALL,
				new BigDecimal("8.05"), maturityDate, exchange, currency,
				new BigDecimal("100"));
		OptionContract c2 = new OptionContract("S", OptionType.CALL,
				new BigDecimal("8.05"), maturityDate, exchange, currency,
				new BigDecimal("100"));
		OptionContract c3 = new OptionContract("S", OptionType.PUT,
				new BigDecimal("8.05"), maturityDate, exchange, currency,
				new BigDecimal("100"));
	...
	public void testCompareTo2() throws ContractException {
		...
		OptionContract c2 = new OptionContract("S", OptionType.CALL,
				new BigDecimal("8.05"), maturityDate, exchange, currency,
				new BigDecimal("100"));
		OptionContract c3 = new OptionContract("S", OptionType.CALL,
				new BigDecimal("8.06"), maturityDate, exchange, currency,
				new BigDecimal("100"));
