...
public class CurrencyTest {
	...
	public void testCreation1() {
		...
		Currency c2 = new Currency("FFF");
		assertEquals("FFF", c2.getCode());
		assertEquals("", c2.getName());

		Currency c3 = new Currency("FFF", null);
		assertEquals("FFF", c2.getCode());
		assertEquals("", c2.getName());
	}
	...
	public void testCreation5() {
		Currency c = new Currency(null, "Name");
	}

	/**
	 * Test of setDecimalPlaces, formatNumber and formatNumberWithCurrency
	 * methods, of class Currency.
	 */
	@Test
	public void testFormatNumber() {
		...
		assertEquals("2.12346FFF", c.formatNumberWithCurrency(new BigDecimal(
				"2.1234599999")));
		...
		assertEquals("1231231231FFF", c
				.formatNumberWithCurrency(new BigDecimal("1231231231")));
	}
