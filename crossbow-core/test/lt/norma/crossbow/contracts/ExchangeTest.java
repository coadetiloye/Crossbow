...
public class ExchangeTest {
	...
	public void testCreatetion() {
		Exchange exchange = new Exchange("A", DateTimeZone
				.forID("America/New_York"), new LocalTime(9, 30, 0),
				new LocalTime(16, 0, 0));
		assertEquals("A", exchange.getName());
		assertEquals(DateTimeZone.forID("America/New_York"), exchange
				.getTimeZone());
	}
	...
	public void testCreatetion2() {
		Exchange exchange = new Exchange(null, DateTimeZone
				.forID("America/New_York"), new LocalTime(9, 30, 0),
				new LocalTime(16, 0, 0));
	}
	...
	public void testCreatetion3() {
		Exchange exchange = new Exchange("", DateTimeZone
				.forID("America/New_York"), new LocalTime(9, 30, 0),
				new LocalTime(16, 0, 0));
	}
	...
	public void testCreatetion4() {
		Exchange exchange = new Exchange("A", null, new LocalTime(9, 30, 0),
				new LocalTime(16, 0, 0));
	}
	...
	public void testCreatetion5() {
		Exchange exchange = new Exchange("A", DateTimeZone
				.forID("America/New_York"), null, new LocalTime(16, 0, 0));
	}
	...
	public void testCreatetion6() {
		Exchange exchange = new Exchange("A", DateTimeZone
				.forID("America/New_York"), new LocalTime(9, 30, 0), null);
	}
	...
	public void testIsTradingHours2() {
		Exchange exchange = new Exchange("A", DateTimeZone
				.forID("America/New_York"), LocalTime.MIDNIGHT,
				LocalTime.MIDNIGHT);
		...
		Exchange exchange2 = new Exchange("A", DateTimeZone
				.forID("America/New_York"), new LocalTime(0, 0, 0),
				new LocalTime(0, 0, 0));
	...
	public void testToString() {
		Exchange exchange = new Exchange("AAAAAAaaaa", DateTimeZone
				.forID("America/New_York"), LocalTime.MIDNIGHT,
				LocalTime.MIDNIGHT);
	...
	public void testEquals() {
		Exchange exchange1 = new Exchange("AAAAAAaaaa", DateTimeZone
				.forID("America/New_York"), LocalTime.MIDNIGHT,
				LocalTime.MIDNIGHT);
		Exchange exchange2 = new Exchange("AAAAAAaaaa", DateTimeZone
				.forID("America/New_York"), new LocalTime(1, 1, 1),
				new LocalTime(2, 2, 2));
		Exchange exchange3 = new Exchange("BAAAAAaaaa", DateTimeZone
				.forID("America/New_York"), new LocalTime(1, 1, 1),
				new LocalTime(2, 2, 2));
	...
	public void testCompareTo() {
		Exchange exchange1 = new Exchange("BB", DateTimeZone
				.forID("America/New_York"), LocalTime.MIDNIGHT,
				LocalTime.MIDNIGHT);
		Exchange exchange2 = new Exchange("BB", DateTimeZone
				.forID("America/New_York"), new LocalTime(1, 1, 1),
				new LocalTime(2, 2, 2));
		Exchange exchange3 = new Exchange("AA", DateTimeZone
				.forID("America/New_York"), new LocalTime(1, 1, 1),
				new LocalTime(2, 2, 2));
		Exchange exchange4 = new Exchange("CC", DateTimeZone
				.forID("America/New_York"), new LocalTime(1, 1, 1),
				new LocalTime(2, 2, 2));
