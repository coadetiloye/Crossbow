...
public class DerivativesContractTest {
	...
	public void testCreation2() throws ContractException {
		DerivativesContract c = new MockDerivativesContract(null,
				new BigDecimal("1"));
	}
	...
	public void testCreation3() throws ContractException {
		DerivativesContract c = new MockDerivativesContract(new DateMidnight(
				2010, 1, 1, DateTimeZone.forID("US/Eastern")), new BigDecimal(
				"0"));
	}
	...
	public void testYearsToMaturity() throws Exception {
		...
		assertEquals(1.0, c.yearsToMaturity(new DateMidnight(2008, 12, 31,
				timeZone)), 0.5 / 365.0);
		assertEquals(2.0, c.yearsToMaturity(new DateMidnight(2007, 12, 31,
				timeZone)), 0.5 / 365.0);
		assertEquals(20.0, c.yearsToMaturity(new DateMidnight(1989, 12, 31,
				timeZone)), 0.5 / 365.0);
		assertEquals(0.5, c.yearsToMaturity(new DateMidnight(2009, 7, 1,
				timeZone)), 0.5 / 365.0);
	}
	...
	public class MockDerivativesContract extends DerivativesContract {
		...
		public MockDerivativesContract(DateMidnight maturityDate,
				...
				throws ContractException {
			super("MSFT", "FUTURES", maturityDate, Exchange
					.createNasdaqExchange(), Currency.createJpy(), multiplier,
					underlyingContract);
		}
