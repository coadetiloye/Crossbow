...
public class QuoteTest {
	...
	public QuoteTest() throws ContractException {
		...
		t = new DateTime(2005, 1, 1, 14, 0, 0, 0, DateTimeZone
	...
	public void testCreation() throws ContractException {
		Quote q = new Quote(s, new BigDecimal("8.05"), 500, new BigDecimal(
				"7.0"), 800, t);

		assertEquals(new StockContract("B", Exchange.createNasdaqExchange(),
				Currency.createEur()), q.getContract());
	...
	public void testCreation2() throws ContractException {
		Quote q = new Quote(null, new BigDecimal("8.05"), 500, new BigDecimal(
				"7.0"), 800, t);
	}
	...
	public void testCreation3() throws ContractException {
		Quote q = new Quote(s, null, 500, new BigDecimal("7.0"), 800, t);
	}
	...
	public void testCreation4() throws ContractException {
		Quote q = new Quote(s, new BigDecimal("8.05"), 500, null, 800, t);
	}
	...
	public void testSpread() {
		Quote q = new Quote(s, new BigDecimal("200.05"), 500, new BigDecimal(
				"200"), 800, t);
		assertTrue(q.spread().compareTo(new BigDecimal("0.05")) == 0);
		Quote q2 = new Quote(s, new BigDecimal("195.02"), 500, new BigDecimal(
				"200"), 800, t);
	...
	public void testToString() {
		Quote q = new Quote(s, new BigDecimal("200.05"), 500, new BigDecimal(
				"200"), 800, t);
		assertEquals(
				"B  ask: 500 @ 200.05  bid: 800 @ 200.00  [2005-01-01 14:00:00]",
				q.toString());
	}
}
