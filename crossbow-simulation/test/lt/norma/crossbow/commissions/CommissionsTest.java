...
public class CommissionsTest {
	...
	public void testCommissionsFlatRate() {
		...
		assertTrue(c.calculate(0, BigDecimal.ZERO).compareTo(
				new BigDecimal("50.00")) == 0);
		assertTrue(c.calculate(-50, new BigDecimal("0.002")).compareTo(
				new BigDecimal("50.00")) == 0);
		assertTrue(c.calculate(10000, new BigDecimal("200.50")).compareTo(
				new BigDecimal("50.00")) == 0);
	}
	 ...
	 * <li>Maximum 0.5% of trade value per order (exchange, ECN, and specialist
	 * fees are <b>not</b> included)
	...
	public void testCommissionsIbStocks() {
		...
		assertTrue(c.calculate(1, new BigDecimal("200")).compareTo(
				new BigDecimal("1")) == 0);
		assertTrue(c.calculate(199, new BigDecimal("200")).compareTo(
				new BigDecimal("1")) == 0);
		assertTrue(c.calculate(201, new BigDecimal("200")).compareTo(
				new BigDecimal("1.005")) == 0);
		assertTrue(c.calculate(1000, new BigDecimal("200")).compareTo(
				new BigDecimal("5")) == 0);
		assertTrue(c.calculate(10000, new BigDecimal("1")).compareTo(
				new BigDecimal("50")) == 0);
		assertTrue(c.calculate(10000, new BigDecimal("0.999")).compareTo(
				new BigDecimal("49.95")) == 0);
		assertTrue(c.calculate(1000000, new BigDecimal("0.05")).compareTo(
	...
	public void testCommissionsIbOptions() {
		...
		// premium >= 0.10 USD
		assertTrue(c.calculate(3, new BigDecimal("0.1")).compareTo(
				new BigDecimal("2.1")) == 0);
		assertTrue(c.calculate(2, new BigDecimal("500")).compareTo(
				new BigDecimal("1.4")) == 0);
		assertTrue(c.calculate(1, new BigDecimal("500")).compareTo(
				new BigDecimal("1")) == 0);
		// premium >= 0.05 USD and < 0.10 USD
		assertTrue(c.calculate(3, new BigDecimal("0.05")).compareTo(
				new BigDecimal("1.5")) == 0);
		assertTrue(c.calculate(14, new BigDecimal("0.05001")).compareTo(
				new BigDecimal("7")) == 0);
		assertTrue(c.calculate(1, new BigDecimal("0.08")).compareTo(
				new BigDecimal("1")) == 0);
		assertTrue(c.calculate(2, new BigDecimal("0.09999")).compareTo(
				new BigDecimal("1")) == 0);
		// premium < 0.05 USD
		assertTrue(c.calculate(5, new BigDecimal("0.000001")).compareTo(
				new BigDecimal("1.25")) == 0);
		assertTrue(c.calculate(14, new BigDecimal("0.02")).compareTo(
				new BigDecimal("3.5")) == 0);
		assertTrue(c.calculate(1, new BigDecimal("0.02")).compareTo(
				new BigDecimal("1")) == 0);
		assertTrue(c.calculate(20, new BigDecimal("0.04999")).compareTo(
				new BigDecimal("5")) == 0);
	}
}
